...
class turtle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('can_move')) {
        this.can_move = initObj.can_move
      }
      else {
        this.can_move = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [can_move]
    bufferOffset = _serializer.bool(obj.can_move, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [can_move]
    data.can_move = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.can_move !== undefined) {
      resolved.can_move = msg.can_move;
    }
    else {
      resolved.can_move = false
    }
